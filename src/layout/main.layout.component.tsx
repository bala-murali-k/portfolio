...
// Define the theme context type (adjust based on your actual context structure)
interface ThemeContextType {
  currentTheme: 'light' | 'dark' | 'highcontrast';
  setCurrentTheme: (theme: 'light' | 'dark' | 'highcontrast') => void;
}

// Helper function to safely get context with null check
...
export default function MainLayout({}: {}) {
  ...
  // Helper function to check if high contrast mode is active
      ...
      <Box sx={{ 
        ...
        <Box sx={{ 
          ...
          <Box sx={{ 
            ...
            <Link
              ...
              style={{
                ...
                border: '3px solid',
                borderColor: isHighContrast() ? '#ffff00' : '#000',
                boxShadow: `6px 6px 0 ${isHighContrast() ? '#ffff00' : theme.palette.primary.a40}`,
              ...
              onMouseEnter={(e) => {
                ...
                e.currentTarget.style.boxShadow = `3px 3px 0 ${isHighContrast() ? '#ffff00' : theme.palette.primary.a40}`;
              }}
              onMouseLeave={(e) => {
                e.currentTarget.style.transform = 'translate(0, 0)';
                e.currentTarget.style.boxShadow = `6px 6px 0 ${isHighContrast() ? '#ffff00' : theme.palette.primary.a40}`;
              }}
            >
              bala.dev
            </Link>
          ...
          <Stack direction="row" spacing={3} alignItems="center">
            ...
            <Stack 
              ...
              sx={{ 
                border: '2px solid',
                borderColor: isHighContrast() ? '#ffff00' : theme.palette.text.primary,
                borderRadius: '30px',
                p: '4px',
        ...
        <Box
          sx={{
            ...
            my: 4,
            border: '3px solid',
            borderColor: isHighContrast() ? '#ffff00' : theme.palette.divider,
            bgcolor: isHighContrast() ? '#000000' : (theme.palette.mode === 'dark' ? theme.palette.surface?.a20 || '#1a1a2e' : theme.palette.primary.a30),
            boxShadow: `8px 8px 0 ${isHighContrast() ? '#ffff00' : theme.palette.primary.main}`,
          }}
        >
          <Box
            component="span"
            sx={{
              ...
              color: isHighContrast() ? '#ffff00' : theme.palette.text.primary,
            }}
          >
